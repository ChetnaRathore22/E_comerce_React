          ...
          <div className="bestseller-active owl-carousel ">
            <div className="bestseller-total ">
              <div className="single-bestseller mb-25 ">
                <div className="bestseller-img ">
                  <a href="# ">
                    <img src="img/product/13.jpg " alt="book " />
                  </a>
              ...
              <div className="single-bestseller ">
                <div className="bestseller-img ">
                  <a href="# ">
                    <img src="img/product/14.jpg " alt="book " />
                  </a>
                  <div className="product-flag ">
                    <ul>
                      <li>
            ...
            <div className="bestseller-total ">
              <div className="single-bestseller mb-25 ">
                <div className="bestseller-img ">
                  <a href="# ">
                    <img src="img/product/15.jpg " alt="book " />
                  </a>
                  <div className="product-flag ">
                    <ul>
                      <li>
              ...
              <div className="single-bestseller ">
                <div className="bestseller-img ">
                  <a href="# ">
                    <img src="img/product/16.jpg " alt="book " />
                  </a>
                  <div className="product-flag ">
                    <ul>
                      <li>
            ...
            <div className="bestseller-total ">
              <div className="single-bestseller mb-25 ">
                <div className="bestseller-img ">
                  <a href="# ">
                    <img src="img/product/17.jpg " alt="book " />
                  </a>
                  <div className="product-flag ">
                    <ul>
                      <li>
